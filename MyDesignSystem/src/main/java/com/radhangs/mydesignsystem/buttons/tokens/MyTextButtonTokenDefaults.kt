...
public class MyTextButtonTokenDefaults(private val themeTokens: ThemeTokensInterface) {
    ...
    public inner class MyTextButtonColorTokenDefaults: MyButtonSurfaceTokenDefaults.MyButtonSurfaceColorTokenInterface {
    ...
    public inner class MyTextButtonDimensionTokenDefaults: MyButtonSurfaceTokenDefaults.MyButtonSurfaceDimensionTokenInterface {
